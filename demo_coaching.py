...
# A few items spanning clearly-bad to clearly-good, including Kayvon's anchors.
SAMPLES = [
    "A conversation from a campaign through the summer.",      # Kayvon's fail anchor
    "Grow Discord.",                                            # vague, no number/date
    "Confirm renewal for 15 whitelisters in June and 25 for July.",  # Kayvon's pass anchor
