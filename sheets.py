...
The Cloud Run service runs as a partner-controlled service account; gspread uses
the ambient identity. The platform partner shares the Sheet with that SA and injects
